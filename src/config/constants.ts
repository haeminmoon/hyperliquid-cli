...
// Builder (hardcoded — not user-configurable)
export const BUILDER_ADDRESS = '0xa6f967d47c6f85a5ba4fc43543e5e1c171cccf98';
export const BUILDER_FEE = 1; // 0.001% per order
export const BUILDER_MAX_FEE_RATE = '0.1%'; // approval ceiling
export const REFERRAL_CODE = '2OOLKIT';
